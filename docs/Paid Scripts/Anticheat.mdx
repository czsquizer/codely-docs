...
<a
  ...
  href="https://forum.cfx.re/t/anticheat-revolutionary-anticheat/4802102"
  target="_blank"
>
  {" "}
  <img
...
<a
  ...
  href="https://store.codely.store/package/4822548"
  target="_blank"
>
  {" "}
  <img
...
- Give Weapon detection (working only with ox_inventory)

:::caution Attention
The OCR does not work with Game Servers. You should avoid using "FiveM Game Hosting" providers, more info in [https://fivem.net/terms](FiveM ToS)
:::
...
In sqz_anticheat, sqz_heartbeat & ocr_python/app.py you should change Token. It should be a random set of characters/letters. Do not put there your Discord Bot token!
...
- `exports['ANTICHEAT_NAME']:WhitelistPlayerPermanent(playerId, bool)`
  ...
  _Use the second argument as `true` or `false` to whitelist player without time limit_
